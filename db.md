...
| `last_active_at` | DATETIME | DEFAULT CURRENT_TIMESTAMP | Zeitpunkt der letzten allgemeinen Server-Aktivität im Chat |
| `customer_last_active_at` | DATETIME | NULL | Echte Live-Heartbeat-Aktivität des Kunden im Chat-Tab (für präzisen Kunden-Online-Status) |
| `created_at` | DATETIME | DEFAULT CURRENT_TIMESTAMP | Erstellungszeitpunkt |
